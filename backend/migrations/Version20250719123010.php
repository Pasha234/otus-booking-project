 ...
 */
final class Version20250719123010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "group" ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->addSql('ALTER TABLE "group" ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
